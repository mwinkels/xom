...
public class MapperFactory {
	...
	public <S, T> ClassMapperBuilder<S, T> fromConfig(ClassMapperConfig config, ConverterRegistry converterRegistry, Class<S> sourceClass, Class<T> targetClass) {
	...
	public <S, T> ConstructorArgumentMapperBuilder fromConfig(ClassMapperBuilder<S, T> classMapperBuilder, ConverterRegistry converterRegistry, ConstructorArgumentMapperConfig config) {

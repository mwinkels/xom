...
public class ConstructorArgumentMapperBuilder extends AbstractElementMapperBuilder {
	...
	public ConstructorArgumentMapperBuilder(ClassMapperBuilder classMapperBuilder, ConverterRegistry converterRegistry, String source, int index, Converter converter) {
